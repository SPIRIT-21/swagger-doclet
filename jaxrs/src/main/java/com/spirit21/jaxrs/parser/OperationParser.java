...
import com.spirit21.jaxrs.handler.annotation.MIMEMediaTypeHandler;
import com.spirit21.jaxrs.handler.parameter.ParameterFactory;
...
public class OperationParser {
	...
	private void setMediaType(Operation operation, MethodDoc methodDoc) {
		Arrays.asList(MIMEMediaTypeHandler.values()).stream()
			.filter(mth -> CommonHelper.hasAnnotation(methodDoc, mth.getMimeMediaType()))
